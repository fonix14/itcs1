...
async def ui_director_landing(request: Request):
  ...
  <div class="page">
    <header class="topbar">
      <div>
        ...
        <h1>Операционный командный центр</h1>
        <div class="subline" id="heroSubtitle">Центральная точка управления системой контроля заявок.</div>
      </div>
    ...
    <section class="hero-grid">
      <div class="card hero-card">
        <div class="card-title">Платформа компании</div>
        <div class="hero-text">
      ...
      <div class="card hero-card accent-card">
        <div class="card-title">Управленческий эффект</div>
        <div id="effectBox">Загрузка...</div>
      </div>
    </section>

    <section class="kpi-grid">
      <div class="card kpi"><div class="label">Активные задачи</div><div class="value" id="kpiTasks">—</div></div>
      <div class="card kpi"><div class="label">Просрочено по SLA</div><div class="value" id="kpiOverdue">—</div></div>
      <div class="card kpi"><div class="label">Открытые аномалии</div><div class="value" id="kpiAnomalies">—</div></div>
      <div class="card kpi"><div class="label">Уровень доверия</div><div class="value" id="kpiTrust">—</div></div>
      <div class="card kpi"><div class="label">Последний импорт</div><div class="value" id="kpiImport">—</div></div>
      <div class="card kpi"><div class="label">Invalid %</div><div class="value" id="kpiInvalid">—</div></div>
    </section>

    <section class="section-title">Модули платформы</section>

    <section class="grid-2">
      <div class="card">
        <div class="card-title">Roadmap развития</div>
        <div id="roadmapBox">Загрузка...</div>
      </div>
      <div class="card">
        <div class="card-title">Что это даёт руководителю</div>
        <div id="leaderBox">Загрузка...</div>
      </div>
    </section>
  </div>
